...
class Linear(DQN):
    ...
    def initialize_models(self):
        ...
        self.q_network = nn.Linear(in_features = img_height*img_width*n_channels*config.state_history, out_features = num_actions)
        self.target_network = nn.Linear(in_features = img_height*img_width*n_channels*config.state_history, out_features = num_actions)
        ##############################################################
        ######################## END YOUR CODE #######################
